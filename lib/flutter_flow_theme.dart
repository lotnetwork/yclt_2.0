...
abstract class FlutterFlowTheme {
  ...
  late Color battleshipGrey;
  late Color gainsboro;
  late Color cultured;
  late Color silverSand;
  late Color ashGrayColor;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF46BCC3);
  late Color secondary = const Color(0xFFF5F9F9);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF7C8788);
  ...
  late Color success = const Color(0xFF009C49);
  late Color warning = const Color(0xFFF1A80F);
  late Color error = const Color(0xFFDD3333);
  late Color info = const Color(0xFFFFFFFF);

  late Color battleshipGrey = const Color(0xFF7C8788);
  late Color gainsboro = const Color(0xFFD7DCDD);
  late Color cultured = const Color(0xFFF1F5F5);
  late Color silverSand = const Color(0xFFB1BCBD);
  late Color ashGrayColor = const Color(0xFFBCCCCD);
  late Color shadowColor = const Color(0x2690B6B8);
  late Color dividerColor = const Color(0xFFF1F5F5);
  late Color grey300 = const Color(0xFFE6E6E6);
}
